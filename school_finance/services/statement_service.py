...
def generate_statement(student, term_id=None, year=None, generated_by_role=None):
    ...
    if generated_by_role:
        c.drawString(x + 5 * mm, table_y, f"Received By: {generated_by_role}")
        table_y -= 5 * mm
    c.drawString(x + 5 * mm, table_y, "Generated By: Bursar")
    table_y -= 5 * mm
